<?php
// templates/header.php (VERSÃƒO FINAL COM BARRA DE PESQUISA)
...
<head>
    ...
    <?php $assetVer = (defined('APP_VERSION') ? APP_VERSION : '2.0.0') . '.' . (defined('APP_REVISION') ? APP_REVISION : 'local'); ?>
    <link rel="stylesheet" href="<?= BASE_URL ?>/assets/plugins/fontawesome-free/css/all.min.css?v=<?= urlencode($assetVer) ?>">
    <link rel="stylesheet" href="<?= BASE_URL ?>/assets/dist/css/adminlte.min.css?v=<?= urlencode($assetVer) ?>">
    <link rel="stylesheet" href="<?= BASE_URL ?>/assets/dist/css/ged_styles.css?v=<?= urlencode($assetVer) ?>">
    <link rel="stylesheet" href="<?= BASE_URL ?>/assets/dist/css/brand.css?v=<?= urlencode($assetVer) ?>">
...
<nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background:#ffffff; border-bottom:1px solid #e5e7eb;">
        ...
        <ul class="navbar-nav ml-auto align-items-center">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" id="btn-toggle-theme" title="Alternar tema">
            ...
            <li class="nav-item dropdown">
                ...
                ?>
                <a class="nav-link" data-toggle="dropdown" href="#" title="NotificaÃ§Ãµes">
